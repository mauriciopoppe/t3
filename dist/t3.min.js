...
(function (global){
function Coordinates(e,i){e=e||{},this.mesh=new THREE.Object3D,this.axes={name:"Axes",mesh:this.drawAllAxes({axisLength:100,axisRadius:1,axisTess:50}),visible:void 0!==e.axes?e.axes:!0},this.ground={name:"Ground",mesh:this.drawGround({size:1e5,color:i.groundColor}),visible:void 0!==e.ground?e.ground:!0},this.gridX={name:"XZ grid",mesh:this.drawGrid({size:1e4,scale:.01,color:i.gridColor}),visible:void 0!==e.gridX?e.gridX:!0},this.gridY={name:"YZ grid",mesh:this.drawGrid({size:1e4,scale:.01,orientation:"y",color:i.gridColor}),visible:void 0!==e.gridY?e.gridY:!1},this.gridZ={name:"XY grid",mesh:this.drawGrid({size:1e4,scale:.01,orientation:"z",color:i.gridColor}),visible:void 0!==e.gridZ?e.gridZ:!1},Coordinates.prototype.init.call(this,e)}var THREE="undefined"!=typeof window?window.THREE:"undefined"!=typeof global?global.THREE:null;Coordinates.prototype.init=function(){var e=this;for(var i in e)if(e.hasOwnProperty(i)){var o=e[i];o.mesh&&(e.mesh.add(o.mesh),o.mesh.visible=o.visible)}return e},Coordinates.prototype.initDatGui=function(e){var i,o=this;i=e.addFolder("Scene helpers");for(var r in o)if(o.hasOwnProperty(r)){var t=o[r];t.hasOwnProperty("mesh")&&i.add(t,"visible").name(t.name).onFinishChange(function(e){return function(i){e.mesh.visible=i}}(t))}return o},Coordinates.prototype.drawGrid=function(e){e=e||{};var i=void 0!==e.color?e.color:"#505050",o=void 0!==e.orientation?e.orientation:"x",r=new THREE.GridHelper(500,10);return r.setColors(11053224,i),"x"===o?r.rotation.x=-Math.PI/2:"y"===o?r.rotation.y=-Math.PI/2:"z"===o&&(r.rotation.z=-Math.PI/2),r},Coordinates.prototype.drawGround=function(e){e=e||{};var i=void 0!==e.size?e.size:100,o=void 0!==e.color?e.color:0,r=void 0!==e.offset?e.offset:-.5,t=new THREE.Mesh(new THREE.PlaneGeometry(i,i),new THREE.MeshBasicMaterial({transparent:!0,side:THREE.DoubleSide,opacity:.6,color:o}));return t.rotation.x=-Math.PI/2,t.position.y=r,t},Coordinates.prototype.drawAxes=function(e){e=e||{};var i=void 0!==e.axisRadius?e.axisRadius:.04,o=void 0!==e.axisLength?e.axisLength:11,r=void 0!==e.axisTess?e.axisTess:48,t=void 0!==e.axisOrientation?e.axisOrientation:"x",n=new THREE.Object3D,a=new THREE.MeshLambertMaterial({color:0,side:THREE.DoubleSide}),s=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,r,1,!0),a);"x"===t?(s.rotation.z=-Math.PI/2,s.position.x=o/2-1):"y"===t&&(s.position.y=o/2-1),n.add(s);var d=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,8*i,r,1,!0),a);return"x"===t?(d.rotation.z=-Math.PI/2,d.position.x=o-1+4*i/2):"y"===t&&(d.position.y=o-1+4*i/2),n.add(d),n},Coordinates.prototype.drawAllAxes=function(e){e=e||{};var i=void 0!==e.axisRadius?e.axisRadius:.04,o=void 0!==e.axisLength?e.axisLength:10,r=void 0!==e.axisTess?e.axisTess:24,t=new THREE.Object3D,n=new THREE.MeshLambertMaterial({color:16711680}),a=new THREE.MeshLambertMaterial({color:65280}),s=new THREE.MeshLambertMaterial({color:255});n.side=THREE.DoubleSide,a.side=THREE.DoubleSide,s.side=THREE.DoubleSide;var d=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,r,1,!0),n),E=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,r,1,!0),a),l=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,r,1,!0),s);d.rotation.z=-Math.PI/2,d.position.x=o/2-1,E.position.y=o/2-1,l.rotation.y=-Math.PI/2,l.rotation.z=-Math.PI/2,l.position.z=o/2-1,t.add(d),t.add(E),t.add(l);var h=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,4*i,r,1,!0),n),w=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,4*i,r,1,!0),a),y=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,4*i,r,1,!0),s);return h.rotation.z=-Math.PI/2,h.position.x=o-1+4*i/2,w.position.y=o-1+4*i/2,y.rotation.z=-Math.PI/2,y.rotation.y=-Math.PI/2,y.position.z=o-1+4*i/2,t.add(h),t.add(w),t.add(y),t},module.exports=Coordinates;
//# sourceMappingURL=t3.map.json
}).call(this,typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
