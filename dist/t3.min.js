...
"use strict";function cloneFunction(func){var out,str;try{str=func.toString(),out=/\[native code\]/.test(str)?func:eval("(function(){return "+str+"}());")}catch(e){throw new Error(e.message+"\r\n\r\n"+str)}return out}module.exports=cloneFunction;
//# sourceMappingURL=t3.map.json
},{}],2:[function(_dereq_,module,exports){
function objectForeach(e,c){"use strict";return Object.keys(e).forEach(function(o){c(e[o],o,e)}),e}module.exports=objectForeach;
//# sourceMappingURL=t3.map.json
},{}],3:[function(_dereq_,module,exports){
function ObjectMergeOptions(e){"use strict";e=e||{},this.depth=e.depth||!1,this.throwOnCircularRef="throwOnCircularRef"in e&&e.throwOnCircularRef===!1?!1:!0}function createOptions(){"use strict";var e=Array.prototype.slice.call(arguments,0);e.unshift(null);var r=ObjectMergeOptions.bind.apply(ObjectMergeOptions,e);return new r}function objectMerge(e){"use strict";function r(e){var r=e.reduce(function(e,r){return r instanceof Object?e.push(r):e=[],e},[]);return r}function t(e){var r,t=e[e.length-1];if(t instanceof Array)r=[];else if(t instanceof Function)try{r=i(t)}catch(n){throw new Error(n.message)}else r=t instanceof Object?{}:t;return r}function n(e){e.forEach(function(e){if(e instanceof Object&&a.indexOf(e)>-1)throw new Error("Circular reference error")}),a=a.concat(e)}function c(e,i){function a(e,r,t){f[r]=f[r]?c([f[r],t[r]],i):c([t[r]],i)}function s(e){o(e,a)}i=u.depth!==!1?i?i+1:1:0,u.throwOnCircularRef===!0&&n(e);var f=t(e);if(f instanceof Object&&i<=u.depth){var l=r(e);l.forEach(s)}return f}var o=_dereq_("object-foreach"),i=_dereq_("clone-function"),a=[],u={};return arguments[0]instanceof ObjectMergeOptions?(u=arguments[0],e=Array.prototype.slice.call(arguments,1)):(u=createOptions(),e=Array.prototype.slice.call(arguments,0)),c(e)}objectMerge.createOptions=createOptions,module.exports=objectMerge;
//# sourceMappingURL=t3.map.json
},{"clone-function":1,"object-foreach":2}],4:[function(_dereq_,module,exports){
(function (global){
"use strict";function Application(e){e=objectMerge({selector:null,width:window.innerWidth,height:window.innerHeight,renderImmediately:!0,injectCache:!1,fullScreen:!1,theme:"dark",ambientConfig:{},defaultSceneConfig:{fog:!0}},e),this.initialConfig=e,this.scenes={},this.activeScene=null,this.cameras={},this.activeCamera=null,this.renderer=null,this.keyboard=null,this.datgui=null,this.stats=null,this.loopManager=null,this.theme=null,this.__t3cache__={},Application.prototype.initApplication.call(this)}var objectMerge=_dereq_("object-merge"),assert=function(e,t){if(!e)throw t||"assertion failed"},emptyFn=function(){},Coordinates=_dereq_("../model/Coordinates"),Keyboard=_dereq_("./Keyboard"),LoopManager=_dereq_("./LoopManager"),Stats=_dereq_("T3.Stats"),dat=_dereq_("T3.dat"),THREE="undefined"!=typeof window?window.THREE:"undefined"!=typeof global?global.THREE:null,THREEx=_dereq_("../lib/THREEx/");Application.prototype.getConfig=function(){return this.initialConfig},Application.prototype.initApplication=function(){var e=this,t=e.getConfig();e.injectCache(t.injectCache),e.setTheme(t.theme),e.createDefaultRenderer(),e.createDefaultScene(),e.createDefaultCamera(),e.createDefaultLights(),e.initDatGui(),e.initStats(),e.initMask().maskVisible(!t.renderImmediately),e.initFullScreen(),e.initKeyboard(),e.initCoordinates(),e.gameLoop()},Application.prototype.setActiveScene=function(e){return this.activeScene=this.scenes[e],this},Application.prototype.addScene=function(e,t){return console.assert(e instanceof THREE.Scene),this.scenes[t]=e,this},Application.prototype.createDefaultScene=function(){var e=this,t=e.getConfig(),i=new THREE.Scene;return t.defaultSceneConfig.fog&&(i.fog=new THREE.Fog(e.theme.fogColor,2e3,4e3)),e.addScene(i,"default").setActiveScene("default"),e},Application.prototype.createDefaultRenderer=function(){var e=this,t=e.getConfig(),i=new THREE.WebGLRenderer({});return i.setClearColor(e.theme.clearColor,1),i.setSize(t.width,t.height),document.querySelector(t.selector).appendChild(i.domElement),e.renderer=i,e},Application.prototype.setActiveCamera=function(e){return this.activeCamera=this.cameras[e],this},Application.prototype.addCamera=function(e,t){return console.assert(e instanceof THREE.PerspectiveCamera||e instanceof THREE.OrthographicCamera),this.cameras[t]=e,this},Application.prototype.createDefaultCamera=function(){var e,t=this,i=t.getConfig(),n=i.width,o=i.height,a={fov:38,ratio:n/o,near:1,far:1e4};return e=new THREE.PerspectiveCamera(a.fov,a.ratio,a.near,a.far),e.position.set(500,300,500),i.fullScreen&&THREEx.WindowResize.bind(t.renderer,e),t.createCameraControls(e).addCamera(e,"default").setActiveCamera("default"),t},Application.prototype.createCameraControls=function(e){var t=this;return e.cameraControls=new THREE.OrbitControls(e,t.renderer.domElement),e.cameraControls.maxPolarAngle=Math.PI/2*.99,e.cameraControls.target.set(100,100,100),t},Application.prototype.createDefaultLights=function(){var e,t=this.scenes["default"];return e=new THREE.AmbientLight(2236962),t.add(e).cache("ambient-light-1"),e=new THREE.DirectionalLight(16777215,1),e.position.set(200,400,500),t.add(e).cache("directional-light-1"),e=new THREE.DirectionalLight(16777215,1),e.position.set(-500,250,-200),t.add(e).cache("directional-light-2"),this},Application.prototype.setTheme=function(e){var t=this,i=_dereq_("../").themes;return assert(i[e]),t.theme=i[e],t},Application.prototype.initMask=function(){var e,t=this,i=t.getConfig();return e=document.createElement("div"),e.className="t3-mask",e.style.position="absolute",e.style.top="0px",e.style.width="100%",e.style.height="100%",e.style.background="rgba(0,0,0,0.5)",document.querySelector(i.selector).appendChild(e),t.mask=e,t},Application.prototype.maskVisible=function(e){var t=this.mask;t.style.display=e?"block":"none"},Application.prototype.initDatGui=function(){var e=this,t=e.getConfig(),i=new dat.GUI({autoPlace:!1});return objectMerge(i.domElement.style,{position:"absolute",top:"0px",right:"0px",zIndex:"1"}),document.querySelector(t.selector).appendChild(i.domElement),e.datgui=i,e},Application.prototype.initStats=function(){var e,t=this,i=t.getConfig();return e=new Stats,objectMerge(e.domElement.style,{position:"absolute",zIndex:1,bottom:"0px"}),document.querySelector(i.selector).appendChild(e.domElement),t.stats=e,t},Application.prototype.initFullScreen=function(){var e=this.getConfig();e.fullScreen&&THREEx.FullScreen.available()&&THREEx.FullScreen.bindKey()},Application.prototype.initCoordinates=function(){var e=this.getConfig();this.scenes["default"].add(new Coordinates(e.ambientConfig,this.theme).initDatGui(this.datgui).mesh)},Application.prototype.initKeyboard=function(){return this.keyboard=new Keyboard,this},Application.prototype.gameLoop=function(){var e=this.getConfig();return this.loopManager=new LoopManager(this,e.renderImmediately).initDatGui(this.datgui).animate(),this},Application.prototype.update=function(e){var t=this;t.stats.update(),t.activeCamera.cameraControls&&t.activeCamera.cameraControls.update(e)},Application.prototype.render=function(){var e=this;e.renderer.render(e.activeScene,e.activeCamera)},Application.prototype.injectCache=function(e){var t,i,n=this,o=THREE.Object3D.prototype.add,a=THREE.Object3D.prototype.remove,r=this.__t3cache__;e?(THREE.Object3D.prototype.add=function(e){return i="add",t=e,o.apply(this,arguments)},THREE.Object3D.prototype.remove=function(e){return i="remove",t=e,a.apply(this,arguments)},THREE.Object3D.prototype.cache=function(e){return assert(t,"T3.Application.prototype.cache: this method needs a previous call to add/remove"),"add"===i?(t.name=t.name||e,assert(t.name),r[t.name]=t):(assert(t.name),delete r[t.name]),t=null,n}):THREE.Object3D.prototype.cache=function(){return this}},Application.prototype.getFromCache=function(e){return this.__t3cache__[e]},Application.run=function(e){e.init=e.init||emptyFn,e.update=e.update||emptyFn,assert(e.selector,"canvas selector required");var t=function(e){Application.call(this,e),e.init.call(this,e)};return t.prototype=Object.create(Application.prototype),t.prototype.update=function(t){Application.prototype.update.call(this,t),e.update.call(this,t)},new t(e)},module.exports=Application;
//# sourceMappingURL=t3.map.json
...
(function (global){
function LoopManager(a,o){this.application=a,this.clock=new THREE.Clock,this.pause=!o,this.fps=60,this.guiControllers={}}var THREE="undefined"!=typeof window?window.THREE:"undefined"!=typeof global?global.THREE:null,Application=_dereq_("./Application");LoopManager.prototype.initDatGui=function(a){var o=this,t=a.addFolder("Game Loop");return t.add(this,"fps",10,60,1).name("Frame rate"),o.guiControllers.pause=t.add(this,"pause").name("Paused").onFinishChange(function(a){a||o.animate(),o.application.maskVisible(a)}),this},LoopManager.prototype.animate=function(){var a,o=this,t=0;return a=function(){if(!o.pause){var e=o.clock.getDelta(),i=1/o.fps;e=Math.min(e,i),t+=e,t>=i&&(o.application.update(e),o.application.render(),t-=i),window.requestAnimationFrame(a)}},a(),o},LoopManager.prototype.start=function(){var a=this;a.guiControllers.pause.setValue(!1)},LoopManager.prototype.stop=function(){var a=this;a.guiControllers.pause.setValue(!0)},module.exports=LoopManager;
//# sourceMappingURL=t3.map.json
}).call(this,typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
(function (global){
function Coordinates(e,i){e=e||{},this.mesh=new THREE.Object3D,this.axes={name:"Axes",mesh:this.drawAllAxes({axisLength:100,axisRadius:1,axisTess:50}),visible:void 0!==e.axes?e.axes:!0},this.ground={name:"Ground",mesh:this.drawGround({size:1e5,color:i.groundColor}),visible:void 0!==e.ground?e.ground:!0},this.gridX={name:"XZ grid",mesh:this.drawGrid({size:1e4,scale:.01}),visible:void 0!==e.gridX?e.gridX:!0},this.gridY={name:"YZ grid",mesh:this.drawGrid({size:1e4,scale:.01,orientation:"y"}),visible:void 0!==e.gridY?e.gridY:!1},this.gridZ={name:"XY grid",mesh:this.drawGrid({size:1e4,scale:.01,orientation:"z"}),visible:void 0!==e.gridZ?e.gridZ:!1},Coordinates.prototype.init.call(this,e)}var THREE="undefined"!=typeof window?window.THREE:"undefined"!=typeof global?global.THREE:null;Coordinates.prototype.init=function(){var e=this;for(var i in e)if(e.hasOwnProperty(i)){var o=e[i];o.mesh&&(e.mesh.add(o.mesh),o.mesh.visible=o.visible)}return e},Coordinates.prototype.initDatGui=function(e){var i,o=this;i=e.addFolder("Scene helpers");for(var t in o)if(o.hasOwnProperty(t)){var r=o[t];r.hasOwnProperty("mesh")&&i.add(r,"visible").name(r.name).onFinishChange(function(e){r.mesh.visible=e})}return o},Coordinates.prototype.drawGrid=function(e){e=e||{};var i=void 0!==e.size?e.size:100,o=void 0!==e.scale?e.scale:.1,t=void 0!==e.color?e.color:"#505050",r=void 0!==e.orientation?e.orientation:"x",n=new THREE.Mesh(new THREE.PlaneGeometry(i,i,i*o,i*o),new THREE.MeshBasicMaterial({color:t,wireframe:!0}));return"x"===r?n.rotation.x=-Math.PI/2:"y"===r?n.rotation.y=-Math.PI/2:"z"===r&&(n.rotation.z=-Math.PI/2),n},Coordinates.prototype.drawGround=function(e){e=e||{};var i=void 0!==e.size?e.size:100,o=void 0!==e.color?e.color:0,t=void 0!==e.offset?e.offset:-.2,r=new THREE.Mesh(new THREE.PlaneGeometry(i,i),new THREE.MeshBasicMaterial({color:o}));return r.rotation.x=-Math.PI/2,r.position.y=t,r},Coordinates.prototype.drawAxes=function(e){e=e||{};var i=void 0!==e.axisRadius?e.axisRadius:.04,o=void 0!==e.axisLength?e.axisLength:11,t=void 0!==e.axisTess?e.axisTess:48,r=void 0!==e.axisOrientation?e.axisOrientation:"x",n=new THREE.Object3D,a=new THREE.MeshLambertMaterial({color:0,side:THREE.DoubleSide}),s=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,t,1,!0),a);"x"===r?(s.rotation.z=-Math.PI/2,s.position.x=o/2-1):"y"===r&&(s.position.y=o/2-1),n.add(s);var d=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,8*i,t,1,!0),a);return"x"===r?(d.rotation.z=-Math.PI/2,d.position.x=o-1+4*i/2):"y"===r&&(d.position.y=o-1+4*i/2),n.add(d),n},Coordinates.prototype.drawAllAxes=function(e){e=e||{};var i=void 0!==e.axisRadius?e.axisRadius:.04,o=void 0!==e.axisLength?e.axisLength:11,t=void 0!==e.axisTess?e.axisTess:48,r=new THREE.Object3D,n=new THREE.MeshLambertMaterial({color:16711680}),a=new THREE.MeshLambertMaterial({color:65280}),s=new THREE.MeshLambertMaterial({color:255});n.side=THREE.DoubleSide,a.side=THREE.DoubleSide,s.side=THREE.DoubleSide;var d=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,t,1,!0),n),E=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,t,1,!0),a),h=new THREE.Mesh(new THREE.CylinderGeometry(i,i,o,t,1,!0),s);d.rotation.z=-Math.PI/2,d.position.x=o/2-1,E.position.y=o/2-1,h.rotation.y=-Math.PI/2,h.rotation.z=-Math.PI/2,h.position.z=o/2-1,r.add(d),r.add(E),r.add(h);var l=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,4*i,t,1,!0),n),w=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,4*i,t,1,!0),a),v=new THREE.Mesh(new THREE.CylinderGeometry(0,4*i,4*i,t,1,!0),s);return l.rotation.z=-Math.PI/2,l.position.x=o-1+4*i/2,w.position.y=o-1+4*i/2,v.rotation.z=-Math.PI/2,v.rotation.y=-Math.PI/2,v.position.z=o-1+4*i/2,r.add(l),r.add(w),r.add(v),r},module.exports=Coordinates;
//# sourceMappingURL=t3.map.json
}).call(this,typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
