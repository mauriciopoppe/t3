...
module.exports=_dereq_("./vendor/dat.gui"),module.exports.color=_dereq_("./vendor/dat.color");
...
"use strict";function Application(e){e=extend({selector:null,width:window.innerWidth,height:window.innerHeight,renderImmediately:!0,injectCache:!1,fullScreen:!1,theme:"dark",helpersConfig:{},defaultSceneConfig:{fog:!0}},e),this.initialConfig=e,this.scenes={},this.activeScene=null,this.cameras={},this.activeCamera=null,this.renderer=null,this.keyboard=null,this.datgui=null,this.stats=null,this.loopManager=null,this.theme=null,this.__t3cache__={},Application.prototype.initApplication.call(this)}var assert=function(e,t){if(!e)throw t||"assertion failed"},emptyFn=function(){},extend=_dereq_("extend"),Stats=_dereq_("stats-js"),dat=_dereq_("dat-gui"),THREE=window.THREE,Coordinates=_dereq_("../model/Coordinates"),Keyboard=_dereq_("./Keyboard"),LoopManager=_dereq_("./LoopManager"),THREEx=_dereq_("../lib/THREEx/");Application.prototype.getConfig=function(){return this.initialConfig},Application.prototype.initApplication=function(){var e=this,t=e.getConfig();e.injectCache(t.injectCache),e.setTheme(t.theme),e.createDefaultRenderer(),e.createDefaultScene(),e.createDefaultCamera(),e.createDefaultLights(),e.initDatGui(),e.initStats(),e.initMask().maskVisible(!t.renderImmediately),e.initFullScreen(),e.initKeyboard(),e.initCoordinates(),e.gameLoop()},Application.prototype.setActiveScene=function(e){return this.activeScene=this.scenes[e],this},Application.prototype.addScene=function(e,t){return console.assert(e instanceof THREE.Scene),this.scenes[t]=e,this},Application.prototype.createDefaultScene=function(){var e=this,t=e.getConfig(),i=new THREE.Scene;return t.defaultSceneConfig.fog&&(i.fog=new THREE.Fog(e.theme.fogColor,2e3,4e3)),e.addScene(i,"default").setActiveScene("default"),e},Application.prototype.createDefaultRenderer=function(){var e=this,t=e.getConfig(),i=new THREE.WebGLRenderer({});return i.setClearColor(e.theme.clearColor,1),i.setSize(t.width,t.height),document.querySelector(t.selector).appendChild(i.domElement),e.renderer=i,e},Application.prototype.setActiveCamera=function(e){return this.activeCamera=this.cameras[e],this},Application.prototype.addCamera=function(e,t){return console.assert(e instanceof THREE.PerspectiveCamera||e instanceof THREE.OrthographicCamera),this.cameras[t]=e,this},Application.prototype.createDefaultCamera=function(){var e,t=this,i=t.getConfig(),n=i.width,a=i.height,o={fov:38,ratio:n/a,near:1,far:1e4};return e=new THREE.PerspectiveCamera(o.fov,o.ratio,o.near,o.far),e.position.set(500,300,500),i.fullScreen&&THREEx.WindowResize.bind(t.renderer,e),t.createCameraControls(e).addCamera(e,"default").setActiveCamera("default"),t},Application.prototype.createCameraControls=function(e){var t=this;return e.cameraControls=new THREE.OrbitControls(e,t.renderer.domElement),e.cameraControls.target.set(0,0,0),t},Application.prototype.createDefaultLights=function(){var e,t=this.scenes["default"];return e=new THREE.AmbientLight(2236962),t.add(e).cache("ambient-light-1"),e=new THREE.DirectionalLight(16777215,1),e.position.set(200,400,500),t.add(e).cache("directional-light-1"),e=new THREE.DirectionalLight(16777215,1),e.position.set(-500,250,-200),t.add(e).cache("directional-light-2"),this},Application.prototype.setTheme=function(e){var t=this,i=_dereq_("../").themes;return assert(i[e]),t.theme=i[e],t},Application.prototype.initMask=function(){var e,t=this,i=t.getConfig();return e=document.createElement("div"),e.className="t3-mask",e.style.position="absolute",e.style.top="0px",e.style.width="100%",e.style.height="100%",e.style.background="rgba(0,0,0,0.5)",document.querySelector(i.selector).appendChild(e),t.mask=e,t},Application.prototype.maskVisible=function(e){var t=this.mask;t.style.display=e?"block":"none"},Application.prototype.initDatGui=function(){var e=this,t=e.getConfig(),i=new dat.GUI({autoPlace:!1});return extend(i.domElement.style,{position:"absolute",top:"0px",right:"0px",zIndex:"1"}),document.querySelector(t.selector).appendChild(i.domElement),e.datgui=i,e},Application.prototype.initStats=function(){var e,t=this,i=t.getConfig();return e=new Stats,extend(e.domElement.style,{position:"absolute",zIndex:1,bottom:"0px"}),document.querySelector(i.selector).appendChild(e.domElement),t.stats=e,t},Application.prototype.initFullScreen=function(){var e=this.getConfig();e.fullScreen&&THREEx.FullScreen.available()&&THREEx.FullScreen.bindKey()},Application.prototype.initCoordinates=function(){var e=this.getConfig();this.scenes["default"].add(new Coordinates(e.helpersConfig,this.theme).initDatGui(this.datgui).mesh)},Application.prototype.initKeyboard=function(){return this.keyboard=new Keyboard,this},Application.prototype.gameLoop=function(){var e=this.getConfig();return this.loopManager=new LoopManager(this,e.renderImmediately).initDatGui(this.datgui).animate(),this},Application.prototype.update=function(e){var t=this;t.stats.update(),t.activeCamera.cameraControls&&t.activeCamera.cameraControls.update(e)},Application.prototype.render=function(){var e=this;e.renderer.render(e.activeScene,e.activeCamera)},Application.prototype.injectCache=function(e){var t,i,n=this,a=THREE.Object3D.prototype.add,o=THREE.Object3D.prototype.remove,r=this.__t3cache__;e?(THREE.Object3D.prototype.add=function(e){return i="add",t=e,a.apply(this,arguments)},THREE.Object3D.prototype.remove=function(e){return i="remove",t=e,o.apply(this,arguments)},THREE.Object3D.prototype.cache=function(e){return assert(t,"T3.Application.prototype.cache: this method needs a previous call to add/remove"),"add"===i?(t.name=t.name||e,assert(t.name),r[t.name]=t):(assert(t.name),delete r[t.name]),t=null,n}):THREE.Object3D.prototype.cache=function(){return this}},Application.prototype.getFromCache=function(e){return this.__t3cache__[e]},Application.run=function(e){e.init=e.init||emptyFn,e.update=e.update||emptyFn,assert(e.selector,"canvas selector required");var t=function(e){Application.call(this,e),e.init.call(this,e)};return t.prototype=Object.create(Application.prototype),t.prototype.update=function(t){Application.prototype.update.call(this,t),e.update.call(this,t)},new t(e)},module.exports=Application;
//# sourceMappingURL=t3.map.json
...
function Keyboard(){this.keys=[]}Keyboard.prototype.init=function(){var e,o=this;for(e=0;256>e;e+=1)o.keys[e]=!1;document.addEventListener("keydown",o.onKeyDown(),!1),document.addEventListener("keyup",o.onKeyUp(),!1)},Keyboard.prototype.onKeyDown=function(){var e=this;return function(o){e.keys[o.keyCode]=!0}},Keyboard.prototype.onKeyUp=function(){var e=this;return function(o){e.keys[o.keyCode]=!1}},Keyboard.prototype.get=function(e){return this.keys[e.charCodeAt(0)]},Keyboard.prototype.set=function(e,o){this.keys[e.charCodeAt(0)]=o},module.exports=Keyboard;
//# sourceMappingURL=t3.map.json
},{}],8:[function(_dereq_,module,exports){
function LoopManager(a,t){this.application=a,this.clock=new THREE.Clock,this.pause=!t,this.fps=60,this.guiControllers={}}var Application=_dereq_("./Application"),THREE=window.THREE;LoopManager.prototype.initDatGui=function(a){var t=this,o=a.addFolder("Game Loop");return o.add(this,"fps",10,60,1).name("Frame rate"),t.guiControllers.pause=o.add(this,"pause").name("Paused").onFinishChange(function(a){a||t.animate(),t.application.maskVisible(a)}),this},LoopManager.prototype.animate=function(){var a,t=this,o=0;return a=function(){if(!t.pause){var i=t.clock.getDelta(),e=1/t.fps;i=Math.min(i,e),o+=i,o>=e&&(t.application.update(i),t.application.render(),o-=e),window.requestAnimationFrame(a)}},a(),t},LoopManager.prototype.start=function(){var a=this;a.guiControllers.pause.setValue(!1)},LoopManager.prototype.stop=function(){var a=this;a.guiControllers.pause.setValue(!0)},module.exports=LoopManager;
//# sourceMappingURL=t3.map.json
},{"./Application":6}],9:[function(_dereq_,module,exports){
_dereq_("./lib/OrbitControls");var Application=_dereq_("./controller/Application"),t3={model:{Coordinates:_dereq_("./model/Coordinates")},themes:{dark:_dereq_("./themes/dark"),light:_dereq_("./themes/light")},controller:{Application:Application,Keyboard:_dereq_("./controller/Keyboard"),LoopManager:_dereq_("./controller/LoopManager")},Application:Application,run:Application.run};module.exports=t3;
//# sourceMappingURL=t3.map.json
...
function Coordinates(i,e){i=i||{},this.mesh=new THREE.Object3D,this.axes={name:"Axes",mesh:this.drawAllAxes({axisLength:100,axisRadius:1,axisTess:50}),visible:void 0!==i.axes?i.axes:!0},this.ground={name:"Ground",mesh:this.drawGround({size:1e5,color:e.groundColor}),visible:void 0!==i.ground?i.ground:!0},this.gridX={name:"XZ grid",mesh:this.drawGrid({size:1e4,scale:.01,color:e.gridColor}),visible:void 0!==i.gridX?i.gridX:!0},this.gridY={name:"YZ grid",mesh:this.drawGrid({size:1e4,scale:.01,orientation:"y",color:e.gridColor}),visible:void 0!==i.gridY?i.gridY:!1},this.gridZ={name:"XY grid",mesh:this.drawGrid({size:1e4,scale:.01,orientation:"z",color:e.gridColor}),visible:void 0!==i.gridZ?i.gridZ:!1},Coordinates.prototype.init.call(this,i)}var THREE=window.THREE;Coordinates.prototype.init=function(){var i=this;for(var e in i)if(i.hasOwnProperty(e)){var o=i[e];o.mesh&&(i.mesh.add(o.mesh),o.mesh.visible=o.visible)}return i},Coordinates.prototype.initDatGui=function(i){var e,o=this;e=i.addFolder("Scene helpers");for(var r in o)if(o.hasOwnProperty(r)){var t=o[r];t.hasOwnProperty("mesh")&&e.add(t,"visible").name(t.name).onFinishChange(function(i){return function(e){i.mesh.visible=e}}(t))}return o},Coordinates.prototype.drawGrid=function(i){i=i||{};var e=void 0!==i.color?i.color:"#505050",o=void 0!==i.orientation?i.orientation:"x",r=new THREE.GridHelper(500,10);return r.setColors(11053224,e),"x"===o?r.rotation.x=-Math.PI/2:"y"===o?r.rotation.y=-Math.PI/2:"z"===o&&(r.rotation.z=-Math.PI/2),r},Coordinates.prototype.drawGround=function(i){i=i||{};var e=void 0!==i.size?i.size:100,o=void 0!==i.color?i.color:0,r=void 0!==i.offset?i.offset:-.5,t=new THREE.Mesh(new THREE.PlaneGeometry(e,e),new THREE.MeshBasicMaterial({transparent:!0,side:THREE.DoubleSide,opacity:.6,color:o}));return t.rotation.x=-Math.PI/2,t.position.y=r,t},Coordinates.prototype.drawAxes=function(i){i=i||{};var e=void 0!==i.axisRadius?i.axisRadius:.04,o=void 0!==i.axisLength?i.axisLength:11,r=void 0!==i.axisTess?i.axisTess:48,t=void 0!==i.axisOrientation?i.axisOrientation:"x",n=new THREE.Object3D,s=new THREE.MeshLambertMaterial({color:0,side:THREE.DoubleSide}),a=new THREE.Mesh(new THREE.CylinderGeometry(e,e,o,r,1,!0),s);"x"===t?(a.rotation.z=-Math.PI/2,a.position.x=o/2-1):"y"===t&&(a.position.y=o/2-1),n.add(a);var d=new THREE.Mesh(new THREE.CylinderGeometry(0,4*e,8*e,r,1,!0),s);return"x"===t?(d.rotation.z=-Math.PI/2,d.position.x=o-1+4*e/2):"y"===t&&(d.position.y=o-1+4*e/2),n.add(d),n},Coordinates.prototype.drawAllAxes=function(i){i=i||{};var e=void 0!==i.axisRadius?i.axisRadius:.04,o=void 0!==i.axisLength?i.axisLength:10,r=void 0!==i.axisTess?i.axisTess:24,t=new THREE.Object3D,n=new THREE.MeshLambertMaterial({color:16711680}),s=new THREE.MeshLambertMaterial({color:65280}),a=new THREE.MeshLambertMaterial({color:255});n.side=THREE.DoubleSide,s.side=THREE.DoubleSide,a.side=THREE.DoubleSide;var d=new THREE.Mesh(new THREE.CylinderGeometry(e,e,o,r,1,!0),n),E=new THREE.Mesh(new THREE.CylinderGeometry(e,e,o,r,1,!0),s),h=new THREE.Mesh(new THREE.CylinderGeometry(e,e,o,r,1,!0),a);d.rotation.z=-Math.PI/2,d.position.x=o/2-1,E.position.y=o/2-1,h.rotation.y=-Math.PI/2,h.rotation.z=-Math.PI/2,h.position.z=o/2-1,t.add(d),t.add(E),t.add(h);var l=new THREE.Mesh(new THREE.CylinderGeometry(0,4*e,4*e,r,1,!0),n),w=new THREE.Mesh(new THREE.CylinderGeometry(0,4*e,4*e,r,1,!0),s),v=new THREE.Mesh(new THREE.CylinderGeometry(0,4*e,4*e,r,1,!0),a);return l.rotation.z=-Math.PI/2,l.position.x=o-1+4*e/2,w.position.y=o-1+4*e/2,v.rotation.z=-Math.PI/2,v.rotation.y=-Math.PI/2,v.position.z=o-1+4*e/2,t.add(l),t.add(w),t.add(v),t},module.exports=Coordinates;
//# sourceMappingURL=t3.map.json
},{}],15:[function(_dereq_,module,exports){
module.exports={clearColor:4144959,fogColor:4144959,groundColor:3355443,gridColor:5592405};
//# sourceMappingURL=t3.map.json
